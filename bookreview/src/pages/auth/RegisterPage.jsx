        ...
        <Grid container sx={{ height: "100vh" }}> 
          ...
          >
            <Container maxWidth="xs">
              ...
              <Box>
                <TextInput variant={"standard"} label={"Name"} fullwidth={true} style={{mb:3}} onChange={setUsername}/>
                <TextInput variant={"standard"} label={"Email"} fullwidth={true} style={{mb:3}} onChange={setUsername}/>
                
                <PasswordInput variant={'standard'} label={"Password"} fullwidth={true} style={{mb:3}} onChange={setPassword}/>
                <PasswordInput variant={'standard'} label={"ConfirmPassword"} fullwidth={true} style={{mb:3}} onChange={setPassword}/>
  
                <Stack direction="row" justifyContent="center" alignItems="center" mt={2}>
                  <Typography variant="body2" color="textSecondary">Do you have an account?</Typography>
                  <Link to="/login" style={{textDecoration:"none", color:"orange", marginLeft:"5px"}}>Sign in</Link>
                    </Stack>
